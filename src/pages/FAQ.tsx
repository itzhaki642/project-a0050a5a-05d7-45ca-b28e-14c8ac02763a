      ...
      questions: [
        {
          ...
          answer: "זמן ההכנה תלוי בסוג המוצר וכמות הפריטים. בדרך כלל, הזמנות מוכנות תוך 3-7 ימי עסקים. להזמנות דחופות, צרו קשר ונשתדל להתאים."
        },
        {
          question: "האם יש משלוחים?",
          answer: "כן! אנחנו מספקים משלוחים לכל הארץ. עלות המשלוח תלויה במיקום ובגודל ההזמנה. ניתן גם לאסוף עצמאית בתיאום מראש."
        },
        {
          question: "מהי מדיניות הביטולים?",
          answer: "ניתן לבטל הזמנה עד 48 שעות לפני מועד האירוע ולקבל החזר מלא. לאחר מכן, ייתכנו דמי ביטול בהתאם לשלב ההכנה."
        },
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "בהחלט! כל המוצרים שלנו ניתנים להתאמה אישית - שם החוגג/ת, גיל, צבעים ועיצוב לפי בקשה. פשוט ציינו את הפרטים בהזמנה."
        },
        {
          question: "מהם הקונספטים הזמינים?",
          answer: "יש לנו מגוון קונספטים כמו נסיכות, גיבורי על, ספארי ועוד. אם יש לכם רעיון לקונספט אחר - דברו איתנו ונשמח ליצור משהו מיוחד."
        },
        {
          question: "מה כולל ערכת יום הולדת?",
          answer: "ערכות יום הולדת כוללות בדרך כלל הזמנות, שלטים, מדבקות, כובעים ועוד. ניתן להרכיב ערכה מותאמת אישית לפי הצרכים שלכם."
        },
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "המזכרות שלנו מתאימות לכל סוגי האירועים - בריתות, בר/בת מצווה, חתונות, ימי הולדת עגולים, אירועי חברה ועוד."
        },
        {
          question: "מה ההבדל בין סוגי המזכרות?",
          answer: "יש לנו מזכרות במחירים ובסגנונות שונים - ממזכרות קטנות ופשוטות ועד מזכרות יוקרתיות ומרשימות. נשמח לייעץ לכם מה מתאים לאירוע שלכם."
        },
        {
